module Ardes#:nodoc:
  ...
  #
  # Basically, within an integration test session, each request stores it's protocol,
  # host and path and that gets added to the next request's headers as HTTP_REFERER
  #
  # If you want to break the chain, just pass :referer => nil in the headers (or
  # pass any other url as the referer)
